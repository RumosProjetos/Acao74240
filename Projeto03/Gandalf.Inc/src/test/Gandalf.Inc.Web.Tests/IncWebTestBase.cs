...
{
    public abstract class IncWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IncWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IncWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IncDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IncDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IncDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IncDbContext, Task<T>> func)
        {
            T result;
