...
namespace Gandalf.Inc.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly IncDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = IncConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IncDbContext context)
        {
            _context = context;
        }
